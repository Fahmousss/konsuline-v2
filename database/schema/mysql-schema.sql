...
CREATE TABLE `consultations` (
  ...
  `status` enum('pending','selesai','berlangsung','menunggu verifikasi') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `hari` enum('Senin','Selasa','Rabu','Kamis','Jumat','Sabtu','Minggu') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Senin',
  `jam_konsultasi` time NOT NULL DEFAULT '08:00:00',
...
CREATE TABLE `doctors` (
  ...
  CONSTRAINT `doctors_specialty_id_foreign` FOREIGN KEY (`specialty_id`) REFERENCES `specialties` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `payments` (
  ...
  `status` enum('berhasil','gagal','pending','menunggu verifikasi') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `payments_consultation_id_unique` (`consultation_id`),
  KEY `payments_patient_id_foreign` (`patient_id`),
  CONSTRAINT `payments_consultation_id_foreign` FOREIGN KEY (`consultation_id`) REFERENCES `consultations` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `users` (
  ...
  `role` enum('pasien','dokter','admin') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pasien',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2025_06_21_062640_create_doctors_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2025_06_21_063638_create_patients_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2025_06_21_184651_create_doctor_schedules_table',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2025_06_22_040548_create_consultations_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2025_06_22_042111_create_payments_table',3);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2025_06_22_160411_create_messages_table',4);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2025_06_23_021734_create_reviews_table',5);
